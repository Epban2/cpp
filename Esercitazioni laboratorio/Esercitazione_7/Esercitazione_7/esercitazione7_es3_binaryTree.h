/*
Esercizio 3: Scrivere una funzione membro pubblica “equal_tree” della classe BinaryTree per
determinare se un albero è uguale ad un albero il cui puntatore viene passato come argomento (due
alberi A e B sono uguali se hanno la stessa struttura e se tutte le coppie di nodi corrispondenti di A e di B
